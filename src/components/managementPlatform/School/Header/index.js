...
const prefix = '/management/school/exercitation'
...
const Header = () => (
  <header className="commons-exercitation-header">
    ...
    <nav ref={nav=>navItems=nav} className="commons-exercitation-nav">
      ...
      />
      <NavBarItem
        to="/management/school/achievement/docking"
        label="成果对接"
      />
      <NavBarItem
        to="/management/school/project/docking"
        label="项目对接"
      />
      <NavBarItem
        to="/management/school/member/center"
        label="会员中心"
      />
    </nav>
